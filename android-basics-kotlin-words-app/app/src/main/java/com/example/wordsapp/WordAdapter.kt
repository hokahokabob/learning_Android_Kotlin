...
class WordAdapter(private val letterId: String, context: Context) :
     ...
     * memo: 用意したViewHolderの管理対象の要素を設定して返すってこと？
     */
     ...
     * memo: method名からして、ViewHolderの管理対象が決まった後に走るってこと？
     */
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            /**
             * ACTION_VIEW は、URI（この場合はウェブアドレス）を受け取る汎用インテントです。
             * これにより、このインテントはユーザーのウェブブラウザで URI を開いて処理するということが、システムに伝わります。
             */
