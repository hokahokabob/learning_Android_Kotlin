...
//        get() = _playlist
    ...
    //Replaced code: TODO: why need to fix as this?
    //               Maybe it's important avoiding MutableLiveData..
    //               No longer need to re-set value to it, because of caching?
    val playlist = this.videosRepository.videos
...
//        refreshDataFromNetwork()
        this.refreshDataFromRepository()
    }
     ...
     * background thread.
     */
    // DONE: Replace with the refreshDataFromRepository() method
